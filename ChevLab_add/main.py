...
def myparser():
    parser = argparse.ArgumentParser(description='ChevLab_add adds together two numbers by putting them into a pandas dataframe and summing the contents. Optionally divides by 2.')
